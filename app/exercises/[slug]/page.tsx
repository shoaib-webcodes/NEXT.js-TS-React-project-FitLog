        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="flex flex-col space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    {/* <button className="flex-1 bg-[#c5ff1d] hover:bg-[#b0e615] text-black font-bold py-3.5 px-6 rounded-xl flex items-center justify-center space-x-2 transition-all shadow-lg">
                        <Calendar className="w-5 h-5" />
                        <span>Add to today's plan</span>
                    </button>
                    <button className="flex-1 bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 text-white font-semibold py-3.5 px-6 rounded-xl flex items-center justify-center space-x-2 transition-all">
